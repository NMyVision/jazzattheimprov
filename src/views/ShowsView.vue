...
<template>
  <div style="background-image: url('/crowd-background.jpg')" class="relative">
    <div class="absolute inset-0 bg-black/75"></div>
    <div class="wrapper space-y-10 z-10 relative">
      ...
      <iframe class="w-full aspect-video rounded-lg shadow-lg "
        :src="`https://www.youtube.com/embed/${current.highlight}`" title="YouTube video player" frameborder="0"
