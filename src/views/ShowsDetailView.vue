          ...
          <div class="mySlides fade h-[40vw] flex" v-for="(artist,index) in episode.members">
            <div class="border-[2px] border-[solid] border-[white] h-full flex justify-center items-center gap-[1vw] p-[1vw]"> <!--Container used to hold carousel elements-->
              ...
              <div class="flex flex-col items-center justify-center w-3/4 h-full">
                <h3 class="mt-6  font-semibold leading-8 text-gray-100 text-[1.9vw]"> {{ artist.name }}</h3> <!--line used to display and style artist name-->
                <p class="instrument text-gray-600 text-center leading-[2vw] text-[1.4vw] mt-[.75vw] -mb-[1.5vw]">{{ artist.instrument }}</p> <!--line used to display and style artist instrument-->
                <p class="mt-4 text-gray-600 text-center p-[1vw] text-[1.1vw] leading-[2vw] w-[30vw]">Praesentium iure error aliquam voluptas ut libero. Commodi
                  placeat sit iure nulla officiis. Ut ex sit repellat tempora. Qui est accusamus exercitationem natus ut
                  voluptas. Officiis velit eos ducimus. </p> <!--test artist bio.. can update once artist bio's are included in the media.ts file -->
                  <ul role="list" class="mt-6 flex gap-x-6 listelements justify-center items-center"> <!-- links and icons used for artist instagram and twitter profiles -->
                  ...
                  <li>
                    <a :href="artist.social.facebook" target="_blank">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-[1.75vw] w-[1.75vw] hover:opacity-[.5]" fill="currentColor" viewBox="0 0 24 24">
                      <path fill-rule="evenodd" d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" clip-rule="evenodd"/>
                      </svg>
                    </a>
                  </li>
          ...
          <div class="mySlides fade h-[40vw] flex">
            <div class="border-[2px] border-[solid] border-[white] h-full flex justify-center items-center gap-[1vw] p-[1vw]">
              ...
              <div class="flex flex-col items-center justify-center w-3/4 h-full">
                ...
                <p class="mt-4 text-gray-600 text-center p-[1vw] text-[1vw] leading-[2vw]">Praesentium iure error aliquam voluptas ut libero. Commodi
                  placeat sit iure nulla officiis. Ut ex sit repellat tempora. Qui est accusamus exercitationem natus ut
