  ...
  <footer class="border-t border-zinc-800/50 mt-10">
    ...
    <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
      <nav class="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12" aria-label="Footer">
        ...
        <div class="pb-6">
          <a href="/" class="text-sm leading-6 text-gray-600 hover:text-gray-900">Memberships</a>
        </div>
        <div class="pb-6">
          <a href="/shows" class="text-sm leading-6 text-gray-600 hover:text-gray-900">Shows</a>
        </div>
        <div class="pb-6">
          <a href="/termsandconditions" class="text-sm leading-6 text-gray-600 hover:text-gray-900">Terms and Conditions</a>
        </div>
        <div class="pb-6">
          <a href="/privacypolicy" class="text-sm leading-6 text-gray-600 hover:text-gray-900">Privacy</a>
        </div>
      </nav>
      <div class="mt-10 flex justify-center space-x-10">
        <a href="https://www.facebook.com/SMOOTHJAZZATTHEIMPROV" target="_blank" class="text-gray-400 hover:text-gray-500">
        ...
        <a href="https://www.instagram.com/smoothjazzattheimprov/" target="_blank" class="text-gray-400 hover:text-gray-500">
        ...
        <a href="https://www.youtube.com/@SmoothJazzattheImprovPresents/videos" target="_blank" class="text-gray-400 hover:text-gray-500">
      ...
      <p class="mt-10 text-center text-xs leading-5 text-gray-500">&copy; {{ new Date().getFullYear() }} Smooth Jazz at the Improv. All rights reserved.
      </p>
    </div>
